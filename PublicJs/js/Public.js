Date.prototype.pattern = function(fmt) { //当前日期
    var o = {
...
! function(win) {
    ...
    Public.prototype.isContains = function(str, substr) { //是否包含字符串
        return new RegExp(substr).test(str);
    };
    Public.prototype.CurentTime = function(){  //返回当前时间 2017-03-01 15:38
        var now = new Date();
